...
class Glass:
    ...
    def add_water(self, new_water):
        self.occupied_volume += new_water
        if self.occupied_volume + new_water > self.capacity_volume:
            raise ValueError("Нельзя перелить воду")
...
if __name__ == "__main__":
    ...
    glass2 = Glass(200, 100)  # TODO инициализировать ещё один стакан
